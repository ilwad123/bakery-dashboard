"""
Django settings for DSP_bakery project.
...
SECRET_KEY = 'django-insecure-&6jh-%6e=n7vx)4cm-w61(n$ga902_zjrc7@g^(ko(yamr_4fj'
...
WSGI_APPLICATION = 'DSP_bakery.wsgi.application'
